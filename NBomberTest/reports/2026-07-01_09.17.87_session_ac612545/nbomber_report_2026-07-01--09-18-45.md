...
session id: `2026-07-01_09.17.87_session_ac612545`
...
|latency|min = `0,18`, mean = `0,78`, max = `2,82`, StdDev = `0,21`|
|latency percentile|p50 = `0,8`, p75 = `0,9`, p95 = `1,01`, p99 = `1,11`|
|data transfer|min = `0,051` KB, mean = `0,051` KB, max = `0,051` KB, all = `0,1` MB|
